...
import www.i.testapplication.network.backend.TestApplicationBackendModule;

@Module(includes = TestApplicationBackendModule.class)
public class NetworkModule
{
    ...
    TypeAdapterFactory provideTypeAdapterFactory() {
        return TestApplicationTypeAdaptorFactory.create();
    }
